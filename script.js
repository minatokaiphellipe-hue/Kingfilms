...
window.iniciarSlider=function(t){totalSlides=t;currentSlide=0;clearInterval(heroInterval);if(t>1)heroInterval=setInterval(()=>{mudarSlide((currentSlide+1)%totalSlides);},8000);};
